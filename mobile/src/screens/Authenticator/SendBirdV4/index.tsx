...
//import React, { useCallback, useRef, useEffect, useState, useLayoutEffect, useContext} from 'react';
//import {
    //GroupChannelModule,
    //GroupChannelFilter,
...
//const SENDBIRD_INFO = {appId: process.env.React_App_SendBird}
//const BasicGroupChannelSample = (props) => {
  //console.log("do we make it in basic")
...
//export  {BasicGroupChannelSample}
